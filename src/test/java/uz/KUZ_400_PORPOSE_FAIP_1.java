...
private String fromResource = "/kuz_400_porpose_faip_1.properties";
  ...
  @Override
  public void runTest() {
	log.logTestName("Создание КУЗ 400 (Предлагается к включению в ФАИП)");
    ...
    faip.selectWithFilter("Код", name_object); 
...
//    fcp.selectWithFilter("Код", fcp_val);
...
//    okei.selectWithFilter("Код", edinica_izmerenija);

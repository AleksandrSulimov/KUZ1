...
public class KUZ_400_NO_FAIP_1 extends JUnitTestBase {
...
//  private Logger log = Logger.getInstance();
  ...
  private String okpd_1, okpd_2, okpd_3, okpd_r, opisanie_zakupki, srok_osushhestvlenija_zakupki, periodichnost_osushhestvlenija_zakupki, obosnovanie_zakupki, cel_osushhestvlenija_zakupki,
	...
	soglasujushhiy, utverzhdajushhiy, telephone_utverzhdajushhego, type_object, faip_code, name_object,napravlenie_investirovanija, kod_uchetnoj_edinicy,
	edinica_izmerenija, moshnost, okved_val;
private String fromResource = "/kuz_400_no_faip_1.properties";
  @Before
  public void initPageObjects() throws IOException {
	...
	this.moshnost=PropertyLoader.loadPropertyLocale("moshnost_val", fromResource);
	this.okved_val=PropertyLoader.loadPropertyLocale("okved_val", fromResource);
  }

  @Override
  public void runTest() {
	log.logTestName("Создание КУЗ 400 (Не включен ФАИП)");
...
//    okei.selectWithFilter("Код", edinica_izmerenija);0
    okei.select(edinica_izmerenija);
    osnovnyeSvedenija.setMoshnost(moshnost);
    osnovnyeSvedenija.clikOkvedSpravochnik();
    okved.selectWithFilter("Код", okved_val);
...
//    log.logTestEnd("Создание КУЗ 400 (Не включен ФАИП)");
  }
//  @After

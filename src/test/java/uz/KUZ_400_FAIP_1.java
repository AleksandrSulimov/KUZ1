...
public class KUZ_400_FAIP_1 extends JUnitTestBase {
...
private String fromResource = "/kuz_400_faip_1.properties";
  @Before
...
//    kosgu.selectWithFilter("Код", kosgu_val);
    ...
    //kppo.selectWithFilter("Кодовое обозначение элемента", "71");

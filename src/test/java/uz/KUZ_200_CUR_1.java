...
import uz.spravochnik.KodValjutySpravochnik;
...
public class KUZ_200_CUR_1 extends JUnitTestBase {
  ...
  private KodValjutySpravochnik currencySpravochnik;
  private Top top;
...
private String fromResource = "/kuz_200_cur_1.properties";
  @Before
  public void initPageObjects() throws IOException {
    ...
    currencySpravochnik = PageFactory.initElements(driver, KodValjutySpravochnik.class);
  ...
  @Override
  public void runTest() {
	log.logTestName("Создание КУЗ 200 (Валютная)");
    ...
    log.logStep(1, "В реестре карточек укрупненных закупок 200 нажать кнопку 'Создать новый документ'");
...
//    osnovnyeSvedenija.setPeriodichnostOsushhestvlenijaZakupki(periodichnost_osushhestvlenija_zakupki);
    ...
    finsCharacteristics.selectCurrencyCheckBox();
    finsCharacteristics.newRowForCurrency();
    ...
    finsCharacteristics.clickCurrencySpravochnick();
    currencySpravochnik.select(currency_val);
    finsCharacteristics.setPredlozhenie2016Valuta(predlozhenie_2016);
    finsCharacteristics.setPredlozhenie2017Valuta(predlozhenie_2017);
    finsCharacteristics.setPredlozhenie2018Valuta(predlozhenie_2018);
...
//    log.logTestEnd("Создание КУЗ 200 (Валютная)");
  }

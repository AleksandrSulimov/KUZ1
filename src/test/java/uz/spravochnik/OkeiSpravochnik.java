 ...
 */
public class OkeiSpravochnik extends Page {
	
	private String table_loc = ".//div[contains(., 'Основная списковая форма')]";//".//th[contains(.,'Код')]/../../../../..";
  ...
  public OkeiSpravochnik(WebDriver webDriver) {
    super(webDriver);
  }

...
/**
 * Федеральная целевая программа справочник
 */
public class FcpSpravochnik extends Page {
	
	private String table_loc = ".//th[contains(.,'Наименование записи')]/../../../../..";//".//th[contains(.,'Код')]/../../../../..";
  ...
  public FcpSpravochnik(WebDriver webDriver) {
    super(webDriver);
  }

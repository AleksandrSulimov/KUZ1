 ...
 * ОКВЭД справочник
 */
public class OkvedSpravochnik extends Page {
  ...
  public OkvedSpravochnik(WebDriver webDriver) {
    super(webDriver);
  }
...
//Left
  ...
  private void selectFirstRow(){
	  ...
	  List<WebElement> list = driver.findElements(By.xpath(select_frst_loc));

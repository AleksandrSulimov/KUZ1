 ...
 * Sample page
 */
public class KbkSpravochnik extends Page {
	/*Расположение модального окна "Выбор записи из справочника 'Цепочки КБК'"*/
	...
	private String desc_loc = rows_loc + "/td[2]/div/span";
	
	/*Расположение панели для перехода по страницам таблицы*/
	...
	/*Поле со значением текущей страницы*/
	private String navigationCurPage_loc = navigation_loc + "//input";
	
	/*Поле со значением Общего количества страниц*/
	private String navigationMaxPage_loc = navigation_loc + "//div[5]/span";

	private String buttonOk = ".//div/button[contains(.,'Отмена')]/preceding-sibling::button[contains(.,'OK')]";
	
	
  public KbkSpravochnik(WebDriver webDriver) {
    super(webDriver);
  }

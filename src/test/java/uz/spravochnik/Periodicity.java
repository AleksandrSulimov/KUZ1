...
public class Periodicity extends Page {
	private String window = "//div[contains(.,'Периодичность осуществления закупки')]/following-sibling::div";
	//фильтр //div[contains(.,'Периодичность осуществления закупки')]/following-sibling::div
	...
	private String filterVisible = table_loc + "/div[1]/table/tbody/tr[1]/th[1]//img";

 ...
 * Sample page
 */
public class DopPriznakSpravochnik extends Page {
//	private String window = ".//div[div[contains(., 'справочник') and contains(.,'Дополнительный аналитический признак')]]/descendant-or-self::*";
  ...
  public DopPriznakSpravochnik(WebDriver webDriver) {
    super(webDriver);
  }
